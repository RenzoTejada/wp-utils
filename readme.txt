...
1. Subir carpeta `wp-utils` al contenido `/wp-content/plugins/`
...
1. Documentación de WP Utils
 

== Changelog ==

= 7.1 (14/06/2025) =
Fix: pruebas de envio con git actions v16

= 7.0 (14/06/2025) =
Fix: pruebas de envio con git actions v15 e ignorando files scan

= 6.9 (14/06/2025) =
Fix: pruebas de envio con git actions v14 e ignorando files scan

= 6.8 (14/06/2025) =
Fix: pruebas de envio con git actions v13 e ignorando files scan

= 6.7 (14/06/2025) =
Fix: pruebas de envio con git actions v12 e ignorando files scan

= 6.6 (14/06/2025) =
Fix: pruebas de envio con git actions v11 e ignorando files scan

= 6.5 (14/06/2025) =
Fix: pruebas de envio con git actions v10 e ignorando files scan

= 6.4 (14/06/2025) =
Fix: pruebas de envio con git actions v9 e ignorando files scan

= 6.3 (14/06/2025) =
Fix: pruebas de envio con git actions v8 e ignorando files scan
...
= 6.0 (13/06/2025) =
Fix: pruebas de envio con git actions v5

= 5.9 (13/06/2025) =
Fix: pruebas de envio con git actions v4

= 5.8 (13/06/2025) =
Fix: pruebas de envio con git actions v3
...
= 5.0 (15/01/2025) =
Fix: remove dir and files v10

= 4.9 (15/01/2025) =
Fix: remove dir and files v9

= 4.8 (15/01/2025) =
Fix: remove dir and files v8

= 4.7 (15/01/2025) =
Fix: remove dir and files v7

= 4.6 (14/01/2025) =
Fix: remove dir and files v6

= 4.5 (14/01/2025) =
Fix: remove dir and files v5

= 4.4 (14/01/2025) =
Fix: remove dir and files v4

= 4.3 (14/01/2025) =
Fix: remove dir and files v3
...
= 4.0 (14/01/2025) =
Fix: Test envio deploy v.4.0 con git actions
...
= 3.7 (14/01/2025) =
Fix: Test envio deploy v.3.7 con git actions

= 3.6 (14/01/2025) =
Fix: Test envio deploy v.3.6 con git actions

= 3.5 (14/01/2025) =
Fix: Test envio deploy v.3.5 con git actions

= 3.4 (14/01/2025) =
Fix: Test envio deploy v.3.4 con git actions

= 3.3 (14/01/2025) =
Fix: Test envio deploy v.3.3 con git actions

= 3.2 (14/01/2025) =
Fix: Test envio deploy v.3.2 con git actions
...
= 2.4 (25/08/2021) =
Fix: levantando las observaciones del team wp.
...
= 0.1.1 =
Actualizando descripcion del plugin WP utils y screenshot 
